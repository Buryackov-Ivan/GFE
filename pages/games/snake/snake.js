...
function drawWin() {
    ...
    // const myArray = ['f56fd6', '5ds6s56', 's6d85ea', '2df5g6', '5re6w6'];
    ...
    context.font = "30px sans-serif"
    context.fillText(`Вы выиграли приз))))`, canvas.width / 2, canvas.height / 2 + 50)
    context.font = "30px sans-serif"
    context.fillText(`Ваш промокод: 268912`, canvas.width / 2, canvas.height / 2 + 100)
    context.font = "30px sans-serif"
    context.fillText(`Промокод дает скидку -15%`, canvas.width / 2, canvas.height / 2 + 140)
}
