...
(function () {
    ...
    var Memory = {
        ...
        binding: function () {
            ...
            this.$outButton.on("click", $.proxy(this.out, this));
            // this.$prom.on("click", $.proxy(this.prom, this));
        },
        ...
        win: function () {
            ...
            setTimeout(function () {
                Memory.showModal();
                Memory.$game.fadeOut();
                // document.writeln("Ваш промокод: 268912");
                // document.writeln("Скидка -15%");
            }, 1000);
        },
